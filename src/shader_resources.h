...
vec4 calculateDirectionalLight(DirectionalLight light, vec3 norm, vec3 viewDir, vec2 uv) {
...
void main()
{
    ...
    for(int i = 0; i < directional_light_number; i++)
        result += calculateDirectionalLight(directionalLights[i], norm, viewDir, new_TexCoord).rgb; 
